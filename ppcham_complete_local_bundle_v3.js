...
(() => {
  ...
  const FALLBACK = {
    ...
    kind:"fallback",
    local_path:"assets/common/pokeball.webp",
    alt:"Poké Ball",
    source_url:null,
...
(() => {
  ...
  const FALLBACK=A.fallback?.local_path || "assets/common/pokeball.webp";
...
(() => {
  ...
  window.PPChamBuildState={
    ...
    assets:{
      ...
      item_icons:true,
      type_icons:true,
      fallback:"assets/common/pokeball.webp"
    },
    completion_percent:98
  };
  console.log("✅ ppcham Complete Local Bundle v2 ready",window.PPChamBuildState);
})();
...
window.PPChamBuildState={...(window.PPChamBuildState||{}),bundle_version:3,completion_percent:99};
