...
(() => {
  ...
  s.id="ppcham-ios-build-hotfix-v1";
  s.textContent='\n/* iOS construction screen hotfix v1 */\n#build #team.team{\n  display:grid!important;\n  visibility:visible!important;\n  opacity:1!important;\n  height:auto!important;\n  min-height:120px!important;\n}\n#build #team.team:empty{\n  display:grid!important;\n}\n@media(max-width:560px){\n  #build #team.team{\n    grid-template-columns:repeat(2,minmax(0,1fr))!important;\n    gap:8px!important;\n    margin-top:12px!important;\n  }\n}\n/* Once tabs are moved out of .top, keep them truly viewport-fixed */\nbody > .tabs{\n  position:fixed!important;\n  left:50%!important;\n  bottom:calc(8px + env(safe-area-inset-bottom))!important;\n  top:auto!important;\n  transform:translateX(-50%)!important;\n  width:min(calc(100% - 18px),680px)!important;\n  z-index:9999!important;\n}\n';
...
/* iOS construction screen hotfix v1 */
(() => {
  if(window.PPChamIOSBuildHotfix) return;

  function moveTabsToViewportRoot(){
    const tabs=document.querySelector(".tabs");
    if(!tabs) return false;
    if(tabs.parentElement!==document.body){
      document.body.appendChild(tabs);
    }
    return true;
  }

  function ensureTeamVisible(){
    const teamEl=document.getElementById("team");
    if(!teamEl) return false;

    teamEl.style.setProperty("display","grid","important");
    teamEl.style.setProperty("visibility","visible","important");
    teamEl.style.setProperty("opacity","1","important");
    teamEl.style.setProperty("height","auto","important");

    if(teamEl.children.length<6 && typeof window.renderTeam==="function"){
      try{ window.renderTeam(); }catch(_){}
    }
    return teamEl.children.length>=1;
  }

  function init(){
    moveTabsToViewportRoot();
    ensureTeamVisible();
  ...
  window.PPChamIOSBuildHotfix={
    ...
    audit(){
      ...
      const teamEl=document.getElementById("team");
      return {
        tabsAtBody:tabs?.parentElement===document.body,
        teamChildren:teamEl?.children.length||0,
        teamDisplay:teamEl?getComputedStyle(teamEl).display:null,
        logicTouched:false
      };
    }
  };
...
(() => {
  const s=document.createElement("style");
  s.id="ppcham-ios-slot-hotfix-v2";
  s.textContent='\n/* iOS build slots hard-visibility hotfix v2 */\n#build #team.team > .slot{\n  -webkit-appearance:none!important;\n  appearance:none!important;\n  display:flex!important;\n  visibility:visible!important;\n  opacity:1!important;\n  background:#ffffff!important;\n  border:1px solid #e5e9f1!important;\n  color:#18212f!important;\n  min-height:120px!important;\n  height:auto!important;\n  position:relative!important;\n  z-index:1!important;\n  overflow:visible!important;\n  transform:none!important;\n  filter:none!important;\n  clip:auto!important;\n  clip-path:none!important;\n  content-visibility:visible!important;\n  pointer-events:auto!important;\n}\n#build #team.team > .slot.empty{\n  border:1px dashed #cbd3df!important;\n  background:#ffffff!important;\n  color:#748094!important;\n  align-items:center!important;\n  justify-content:center!important;\n  font-weight:800!important;\n  font-size:16px!important;\n}\n#build #team.team > .slot .num{\n  display:block!important;\n  visibility:visible!important;\n  opacity:1!important;\n  color:#98a2b3!important;\n}\n';
  document.head.appendChild(s);
})();

/* iOS build slots hard-visibility hotfix v2 */
(() => {
  if(window.PPChamIOSSlotHotfixV2) return;

  function repairSlots(){
    const teamEl=document.getElementById("team");
    if(!teamEl) return {ok:false,count:0};

    if(teamEl.children.length<6 && typeof window.renderTeam==="function"){
      try{ window.renderTeam(); }catch(_){}
    }

    const slots=[...teamEl.children].filter(el=>el.classList?.contains("slot"));

    slots.forEach((slot,i)=>{
      slot.style.setProperty("-webkit-appearance","none","important");
      slot.style.setProperty("appearance","none","important");
      ...
      slot.style.setProperty("background","#fff","important");
      slot.style.setProperty("border",slot.classList.contains("empty")?"1px dashed #cbd3df":"1px solid #e5e9f1","important");
      slot.style.setProperty("color",slot.classList.contains("empty")?"#748094":"#18212f","important");
      slot.style.setProperty("min-height","120px","important");
      ...
      if(slot.classList.contains("empty")){
        ...
        if(!txt || !txt.includes("追加")){
          slot.innerHTML=`＋ 追加<div class="num">${i+1}</div>`;
        }
      }
    });
    ...
    return {
      ...
      first:slots[0] ? {
        ...
        display:getComputedStyle(slots[0]).display,
        opacity:getComputedStyle(slots[0]).opacity,
        visibility:getComputedStyle(slots[0]).visibility,
        background:getComputedStyle(slots[0]).backgroundColor
      } : null
    };
  }
  ...
  function init(){
    repairSlots();
    setTimeout(repairSlots,50);
    setTimeout(repairSlots,250);
    setTimeout(repairSlots,1000);
  }
